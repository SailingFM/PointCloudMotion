...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PaintCanvas_t, stringdata) + ofs \
...
const QMetaObject PaintCanvas::staticMetaObject = {
    { &QGLViewer::staticMetaObject, qt_meta_stringdata_PaintCanvas.data,
      qt_meta_data_PaintCanvas,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PaintCanvas.stringdata))
        return static_cast<void*>(const_cast< PaintCanvas*>(this));
