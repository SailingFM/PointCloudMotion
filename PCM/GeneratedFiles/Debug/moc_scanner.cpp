...
void Scanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Scanner::finished_scan)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Scanner::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Scanner.data,
      qt_meta_data_Scanner,  qt_static_metacall, 0, 0}
};
